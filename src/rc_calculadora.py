...
Basado en gramática ANTLR4 con visitor en Python
"""
...
# Añadir directorio de gramáticas al path
...
class RCCalculadora:
    ...
    def ejecutar_archivo(self, ruta_archivo):
        ...
        try:
            ...
            # Ejecutar código
            self.ejecutar_codigo(codigo, ruta_archivo)
    ...
    def ejecutar_codigo(self, codigo, fuente="<entrada>"):
        """
